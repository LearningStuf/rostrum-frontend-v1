    ...
    <main className='relative w-full h-auto'>
      ...
      <div className='w-ful h-full relative mt-10 mb-10'>
        <div className='max-w-full md:max-w-screen-xl h-full mx-2 p-3 md:p-6 md:mx-auto'>
          ...
          {/* SECTION END */}
          {/* SECTION START */}
          <div className='w-full h-auto grid grid-cols-12 gap-10 mt-14'>
            <section className='h-full col-span-12 md:col-span-5'>
              <Image
          ...
          <div className='w-full h-auto mt-14'>
            ...
            <div className='w-full h-auto grid grid-cols-12 gap-10 mt-8'>
              <section className='h-full col-span-12 md:col-span-7'>
