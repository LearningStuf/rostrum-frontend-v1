        ...
        <div className="max-w-full md:max-w-screen-xl h-full mx-2 p-3 md:p-6 md:mx-auto">
          ...
          <div className="w-full h-auto mt-20">
            ...
            <div className="w-full h-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
              {[
                `Making a fashion/design portfolio to demonstrate your artistic ability and unique identity through variety of artistic and design techniques`,
                `Making sure your fashion portfolio stands out by evaluating it against a checklist of important components 
                (that the top Design schools like and appreciate)`,
                `Assessing what institutions and companies want to see in your portfolio to assist them grasp your artistic flare`,
                `Recognising the value of your portfolio as a means 
                of communicating with colleges and jobs`,
                `Avoiding common errors while submitting your work which is to be reviewed by others`,
                `We edit your portfolio to perfection`,
              ].map((item, i) => {
                return (
