          ...
          <div className="w-full h-auto grid grid-cols-1 md:grid-cols-2 gap-8 ">
            <section>
              <section className='mb-6 md:mb-auto' >
                ...
                <p className="text-[16px] md:text-[20px] text-primary font-normal text-center md:text-left mt-4">
                  The BMAT has a specific testing approach and contents. Preparation requires a focused approach. First, you must understand the test structure. Use official sources for practice tests and past papers and plan your preparation accordingly.
                </p>
              ...
              <section className='mb-6 md:mb-auto' >
                ...
                <p className="text-[16px] md:text-[20px] text-primary font-normal text-center md:text-left mt-4">
                  Go through multiple practice tests to improve on the test. Focus on completing the questions within their allocated periods. Simulate test conditions to familiarize yourself with the pacing.
                </p>
              </section>
              <section className='mb-6 md:mb-auto' >
                <h6 className="text-[22px] md:text-[28px] text-primary  text-center md:text-left font-bold leading-tight ">
                ...
                <p className="text-[16px] md:text-[20px] text-primary font-normal text-center md:text-left mt-4">
                 Assess your strengths and weaknesses and divide and prioritize your time accordingly.
                </p>
            ...
            <section>
              <section className='mb-6 md:mb-auto' >
                <h6 className="text-[22px] md:text-[28px] text-primary  text-center md:text-left font-bold leading-tight ">
                  4.  Section 1 is Problem Solving
                </h6>
                <p className="text-[16px] md:text-[20px] text-primary font-normal text-center md:text-left mt-4">
                  The first BMAT section consists of questions to test problem-solving skills. Stay calm under pressure and approach the questions logically. Break down the problem and use logical reasoning to eliminate answers. Practice makes perfect!
                </p>
              </section>
              <section className='mb-6 md:mb-auto' >
                <h6 className="text-[22px] md:text-[28px] text-primary  text-center md:text-left font-bold leading-tight ">
                  5.  Section 2 Tests Scientific Knowledge
                </h6>
                <p className="text-[16px] md:text-[20px] text-primary font-normal text-center md:text-left mt-4">
                  The BMAT tests your scientific knowledge. It ensures you have a strong grasp of your key concepts in biology, chemistry, physics, and mathematics.
                </p>

              </section>
              <section>
                <h6 className="text-[22px] md:text-[28px] text-primary  text-center md:text-left font-bold leading-tight ">
                  6. Section 3 Analyzes Critical Skills and Writing
                </h6>
                <p className="text-[16px] md:text-[20px] text-primary font-normal text-center md:text-left mt-4">
                  Now, practice your critical analysis and comprehension skills. Read scientific articles and summarize key points every day to improve these skills.
                </p>
              </section>
              {/* <section>
                <h6 className="text-[22px] md:text-[28px] text-primary  text-center md:text-left font-bold leading-tight ">
