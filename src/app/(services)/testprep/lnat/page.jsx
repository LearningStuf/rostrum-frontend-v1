...
const LNAT = () => {
  ...
  return (
    <main className='relative w-full h-auto'>
      <HeaderBanner align='left' title={'LNAT EXAM PREPARATION'} />
          ...
          <div className='w-full h-auto grid grid-cols-1 md:grid-cols-2 gap-6 mt-14'>
            ...
            <section className=''>
              ...
              <div className='flex items-start flex-wrap'>
                <p className='text-[16px] md:text-[20px] text-primary font-bold text-left mt-4 me-14'>
                  Ethics
                </p>
                <p className='text-[16px] md:text-[20px] text-primary font-bold text-left mt-4 me-14'>
                  Media
          ...
          <div className='w-full h-auto mt-14'>
            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
              {universities.map((item, i) => (
                <p
                  key={i}
                  className='text-[16px] md:text-[20px] text-primary font-bold text-left'
                >
                  {item}
                </p>
              ))}
